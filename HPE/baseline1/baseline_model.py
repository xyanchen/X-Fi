...
class single_feature_extrator(nn.Module):
    def __init__(self, modality_list):
        ...
        if 'rgb' in modality_list:
            ...
            rgb_model.load_state_dict(torch.load(parentdir + 'backbones/RGB_benchmark//RGB_Resnet18.pt'))
        ...
        if 'depth' in modality_list:
            ...
            depth_model.load_state_dict(torch.load(parentdir + 'backbones/depth_benchmark/depth_Resnet18.pt'))
        ...
        if 'mmwave' in modality_list:
            ...
            mmwave_model.load_state_dict(torch.load(parentdir + 'backbones/mmwave_benchmark/mmwave_all_random.pt'))
        ...
        if 'lidar' in modality_list:
            ...
            lidar_model.load_state_dict(torch.load(parentdir +'backbones/lidar_benchmark/lidar_all_random.pt'))
        ...
        if 'wifi-csi' in modality_list:
            sys.path.insert(0, parentdir + 'backbones/CSI_benchmark')
            csi_model = torch.load(parentdir + 'backbones/CSI_benchmark/protocol3_random_1.pkl')

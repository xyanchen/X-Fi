...
# from infer_3d_fair_videopose3d import inference as fair_infer_3d_kps
...
if __name__ == '__main__':
    ...
    for protocol_setting in setting_list:
        for round_idx in round_list:
            ...
            rng_generator = torch.manual_seed(63)
            ...
            for m in model_pos_train.modules():
            ...
            train_generator = ChunkedGenerator(1024, None, poses_3d_in, poses_2d_in, 1,
                                               pad=pad, causal_shift=causal_shift, shuffle=True, random_seed=3456,
                                               augment=True, kps_left=kps_left, kps_right=kps_right, joints_left=joints_left,

...
import yaml
from HAR_lidar_benchmark.pointnet_util import PointNetFeaturePropagation, PointNetSetAbstraction
from HAR_lidar_benchmark.pointnet_util import index_points, square_distance
...
class lidar_PointTransformerReg(nn.Module):
    def __init__(self):
        super().__init__()
        root = "C:/Users/Chen_Xinyan/Desktop/Modality_Invariant/HAR"
        with open(root + '/HAR_lidar_benchmark/model_config.yaml', 'r') as fd:

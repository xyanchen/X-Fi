...
class cross_modal_transformer(nn.Module):
    def __init__(self, num_feature=32, max_num_modality=5, dim_expansion=2, emb_size = 512, num_heads = 8, dropout=0.3):
...
class MI_Transformer(nn.Module):
    def __init__(self, num_modalities, dim, qkv_hidden_expansion, hidden_dim, num_feature, num_heads, dim_heads, model_depth, dropout):
        ...
        self.transformer_layers = fusion_transformer_block(dim, hidden_dim, num_heads, dim_heads, num_modalities, dropout)

...
class NTU_Fi_ResNet(nn.Module):
    def __init__(self, ResBlock, layer_list, num_classes):
        ...
        self.reshape = nn.Sequential(
            nn.Linear(30, 32),
            nn.ReLU(),
            nn.Conv2d(1,3,(15,1),stride=(3,1)),
            nn.ReLU(),
            nn.Conv2d(3,3,kernel_size=(3,1),stride=1),
            nn.ReLU()
        )
        self.in_channels = 64

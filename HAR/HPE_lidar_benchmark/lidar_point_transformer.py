...
import yaml
from HPE_lidar_benchmark.pointnet_util import PointNetFeaturePropagation, PointNetSetAbstraction
from HPE_lidar_benchmark.pointnet_util import index_points, square_distance
...
class lidar_PointTransformerReg(nn.Module):
    def __init__(self):
        ...
        with open(root + '/HPE_lidar_benchmark/model_config.yaml', 'r') as fd:

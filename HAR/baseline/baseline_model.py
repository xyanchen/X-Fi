...
parentdir = "C:/Users/Chen_Xinyan/Desktop/Modality_Invariant/HAR"
...
class single_feature_extrator(nn.Module):
    def __init__(self, modality_list):
        ...
        if 'rgb' in modality_list:
            ...
            rgb_model.load_state_dict(torch.load(parentdir + '/HAR_RGB_benchmark/rgb_ResNet18/RGB_Resnet18.pt'))
        ...
        if 'depth' in modality_list:
            ...
            depth_model.load_state_dict(torch.load(parentdir + '/HAR_depth_benchmark/depth_Resnet18.pt'))
        ...
        if 'mmwave' in modality_list:
            ...
            mmwave_model.load_state_dict(torch.load(parentdir + '/HAR_mmwave_benchmark/mmwave_all_random_TD.pt'))
        ...
        if 'lidar' in modality_list:
            ...
            lidar_model.load_state_dict(torch.load(parentdir + '/HAR_lidar_benchmark/lidar_all_random.pt'))
